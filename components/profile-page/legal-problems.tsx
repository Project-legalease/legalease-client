...
function LegalProblemSection() {
  ...
  return (
    <div className="flex h-1/3 w-full p-3">
      <div className="flex flex-col w-1/2">
        <div className="mb-8">
          ...
          <div className="w-fit flex gap-1 mt-4 px-52 ">
        ...
        <div className="flex justify-center mx-6 rounded-lg gap-4 mb-8 bg-black bg-opacity-50 bg-cover z-0 h-[70px] w-[500px] bg-[url('/images/book-appointment-bg.png')]">
      ...
      <div className="bg-[url('/images/book-appointment-bg2.png')] w-1/2 rounded-2xl"></div>
    </div>
  );
}
