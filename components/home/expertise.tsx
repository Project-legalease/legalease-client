...
function LawyerExpertise(): React.JSX.Element {
  return (
    <div className="relative z-0 bg-[url('/images/lawyer-2.jpeg')] bg-center bg-no-repeat bg-cover px-5">
      ...
      <div className="relative z-[2]  py-24 flex flex-col justify-center items-center">
        <h1 className="text-3xl md:text-[40px] text-white text-center font-lilita">
          WANT TO USE YOUR EXPERTISE?
        </h1>
        <h1 className="text-3xl md:text-[40px] text-primary-orange61 text-center font-lilita">
          Join As a Lawyer
        </h1>
        <p className="text-sm sm:text-xl text-white text-center font-bold italic mb-10">
